...
<title>Paddling the Allegheny</title>
<meta name="description" content="Where to put in, where you may legally camp,
what the water is doing right now, and who to call — the Allegheny River from
Coudersport to Pittsburgh, by river mile.">
...
<section id="gaps">
  <h2>What is missing, and how to fix it</h2>
  <p class="lede">This carries __NLAUNCH__ public launches and __NCAMP__
  campgrounds within a mile of the water, taken from state and federal
  mapping. <b>It is certainly incomplete.</b> Stewards and locals know
  launches that appear on no map, and township and private accesses turn over
  constantly. If you know one that is missing, or one on here that is gone,
  say so — the fix takes minutes and everyone downstream benefits.</p>
</section>
